...
const PaymentProcess = () => {
  ...
  useEffect(() => {
    ...
    $("#number_two").on("click", function () {
      $(
        "#recipient_block, #pay_block,  #recipient_gif, #confirm_pay_gif"
      ).hide();
    ...
    readMoreButton.on("click", function () {
      globallyContent.append(
        " Instantly exchangeable for local consumption. Spend it in dollars, Euro, Pesos, or any of 65+ different currencies."
      );
      readMoreButton.hide();
      readLessButton.show();
    ...
    $(".read_more_safe").on("click", function () {
      safeContent.append(
        "  It is only available to you and requires your biometrics to access. Your TagoCash is not stored or controlled by the Tago Platform. It is only referenced on the wallet controlled by you."
      );
    ...
    $(".read_more_privacy").on("click", function () {
      privacyContent.append(
        " You do not need to share your address or bank or credit/debit card details with anyone. When you want to give TagoCash to someone, you only need their mobile number and email address."
      );
    ...
    return () => {
      $(
        "#recipient_title, #amount_title, #confirm_pay_title, .read_more_safe, .read_less_safe, .read_more_privacy, .read_less_privacy, #number_one, #number_two, #number_three"
      ).off("click");
        ...
        <div className="d-flex justify-content-around gap-lg-0 gap-5">
          ...
          <div>
            <div id="recipient_gif">
              <Lottie options={recipientOptions} height={475} width={500} />
            </div>

            <div id="amount_gif">
              <Lottie options={amountOptions} height={475} width={500} />
            </div>

            <div id="confirm_pay_gif">
              <Lottie options={confirmPayOptions} height={475} width={500} />
            </div>
          </div>
        </div>
        ...
        <div className="d-block d-md-none">
          <div className="numbers_mobile">
            <div className="d-flex justify-content-around">
              <div id="number_one" className="pointer">
                <p
                  id="mobile_btn1"
                  className="border border-dark rounded-4 px-4 fw-semibold fs-5 active"
                >
                  1
                </p>
              </div>
              <div id="number_two" className="pointer">
                <p
                  id="mobile_btn2"
                  className="border border-dark rounded-4 px-4 fw-semibold fs-5"
                >
                  2
                </p>
              </div>
          ...
          <div className="payment_process_card text-center">
            <div id="recipient_block">
              <h3 className="hero_subtitle subtitle_small payment_process_title pointer">
                Choose Recipient
              </h3>
          ...
          <div className="margin_top">
            <div className="d-none d-md-flex justify-content-around">
              <div className="position-relative">
                <img
                  className="tagocash_different_dimension"
              ...
              <div className="mt-5 ms-4">
                <div>
                  ...
                  <div
                    id="globally_content"
                    className="sub_text tagocash_features_text"
                  >
                    TagoCash is the cash of where you happen to be
                  </div>
                  <p className="read_more tagocash_features_text tagocash_features_title pointer">
                    Read more
                  </p>
                  <p className="tagocash_features_text read_less tagocash_features_title pointer">
                    Read Less
                  </p>
                </div>
                ...
                <div className="mt-5">
                  <div className="d-flex gap-2 align-items-center">
                    ...
                    <img
                      ...
                      height={"24px"}
                    />
                    <h3 className="hero_subtitle safe_title">
                  ...
                  <p className="read_more_safe tagocash_features_title tagocash_features_text pointer">
                    Read more
                  </p>
                  <p className="read_less_safe tagocash_features_title tagocash_features_text pointer">
                    Read Less
                  </p>
                </div>
                ...
                <div className="mt-5">
                  <div className="d-flex gap-2 align-items-center">
                    ...
                    />
                    <img
                      id="privacy_blue_star"
                      src={blue_star}
                      alt="star"
                      width={"24px"}
                      height={"24px"}
                    />
                    <h3 className="hero_subtitle privacy_title">
                      TagoCash is private
                    </h3>
                  </div>
                  <div
                  ...
                  <p className="read_more_privacy tagocash_features_title tagocash_features_text pointer">
                    Read more
                  </p>
                  <p className="read_less_privacy tagocash_features_title tagocash_features_text pointer">
                    Read Less
                  </p>
                </div>
              </div>
                    ...
                    <div className="feature_cards p-3">
                      <div className="d-flex gap-2">
                        <img
                          ...
                          alt=""
                        />
                        <h3 className="feature_card_title">
                          Globally available
                        </h3>
                      </div>
                      <p className="blog_type_text text-dark ps-4">
                        Instantly exchangeable for local consumption. Spend it
                        in dollars, Euro, Pesos, or any of 65+ different
                        currencies.
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="mb-2">
                    <div className="feature_cards p-3">
                      ...
                      <p className="blog_type_text text-dark ps-4">
                        ...
                        TagoCash to someone, you only need their mobile number
                        and email address.
                      </p>
                    </div>
                  </div>
