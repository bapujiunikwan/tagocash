    ...
    <div className='news_letter_section position-relative'>
      <div className="container">
        <div className="d-md-flex d-none">
          <div className='ms-2'>
              <img className='news_letter_size' src={news_letter} width={"630px"} height={"269px"} alt="" />
          </div>
       ...
       <div className='d-block d-md-none'>
          <div>
            <img className='pb-1 position-relative' src={news_letter_mobile} width={"320px"} height={"200px"} alt="" />
          </div>
